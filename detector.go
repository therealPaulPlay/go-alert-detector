...
var alertRules = []rule{
	{name: "alarm-tonal", minHPR: 0.5, maxPitchRange: 0.18, maxTonality: 1.5, minPurity: 0.6, maxOscCV: 0.7, maxEnvReg: 0.95, maxRmsOsc: 12},
	{name: "alarm-tonal-osc", minHPR: 0.5, maxPitchRange: 0.18, maxTonality: 1.5, minPurity: 0.6, minRmsOsc: 5, maxEnvReg: 0.95, maxRmsOsc: 12},
	{name: "alarm-beat", minHPR: 0.5, maxPitchRange: 0.15, maxTonality: 1.6, maxOscCV: 0.15, maxOverallTon: 1.6, maxEnvReg: 0.95, maxRmsOsc: 15},
	{name: "alarm-shifted", minHPR: 0.3, maxPitchRange: 0.15, maxTonality: 1.5, minPurity: 0.85, maxOscCV: 0.7, maxOverallTon: 1.6, maxEnvReg: 0.95, maxRmsOsc: 15},
	{name: "alarm-stable", minMaxZCR: 0.035, maxOscCV: 0.1, maxOverallTon: 0.8, minMidHigh: 0.4, maxEnvReg: 0.6},
	...
	{name: "siren-midhigh", minMaxZCR: 0.035, minOscCV: 0.2, minZcrCV: 0.2, maxZcrCV: 0.4, maxOverallTon: 0.75, maxEnvReg: 0.65, minPurity: 0.65, minOsc: 4, maxOsc: 20, minMidHigh: 0.5},
	{name: "siren-distant", minMaxZCR: 0.035, minOscCV: 0.2, minZcrCV: 0.08, maxEnvReg: 0.44, minPurity: 0.75, maxOverallTon: 0.7, minOsc: 4, maxOsc: 20},
	{name: "siren-distant-bandfocus", minMaxZCR: 0.035, minOscCV: 0.2, minZcrCV: 0.08, maxEnvReg: 0.5, minPurity: 0.75, maxOverallTon: 0.7, minOsc: 4, maxOsc: 20, minBandFocus: 0.43},
